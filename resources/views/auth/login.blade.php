                        ...
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-warning shadow-primary border-radius-lg py-3 pe-1">
                                    <h4 class="text-white font-weight-bolder text-center my-2">Sistem Informasi <br> Penggajian</h4>
                                </div>
                            </div>
                            <div class="card-body">                                
                                <form action="" method="post">
                                    ...
                                    <div class="text-center">
                                        <button type="button" class="btn bg-gradient-warning w-100">Login</button>
                                    </div>
                                </form>
                            </div>
                        </div>
